...
class hadd:
    ...
    def __init__(self, outfile, inFiles, tmpdir, verbose=False, vverbose=False, quiet=False, force_overwrite=False, save=False, nAtOnce=2, nJobs=1):
        """ Set up the class """
...
if __name__ == '__main__':
    ...
    parser.add_option("-n", "--n-files-at-once", action="store", type="int", dest="nAtOnce", default=2, help="combine this many files at one time [defualt 2]")
