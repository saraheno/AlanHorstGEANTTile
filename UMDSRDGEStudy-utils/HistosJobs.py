...
WorkDir = "home/ahorst/UMDSRDGEStudy-build/HistosRoots/Irr10000"
...
for x in range(len(Arr)):
	for y in range(len(Arr2)):
		...
		sTag = "DataCollectionHistos{0}[{1}][{2}]".format(q,Arr[x],Arr2[y])
        	if (-2.4<Arr[x]<2.4 and 4.45<Arr2[y]<4.75) or (-2.4<Arr[x]<2.4 and -4.75<=Arr2[y]<-4.45):
            		a = True
        	elif (-2.40<Arr2[y]<2.40 and -4.75<Arr[x]<-4.45):
            		a = True
        	elif (-5.0<Arr2[y]<2.40 and 4.45<Arr[x]<4.75):
            		a = True
        	elif (1.9<Arr2[y]<2.90 and 4.3<Arr[x]<4.5) or (1.9<Arr2[y]<2.90 and -4.5<Arr[x]<-4.3) or (-2.90<Arr2[y]<-1.9 and -4.5<Arr[x]<-4.3) or (-2.90<Arr2[y]<-1.9 and 4.3<Arr[x]<4.5):
            		a = True
        	elif (2.5<Arr2[y]<3.00 and 4.1<Arr[x]<4.3) or (2.5<Arr2[y]<3.00 and -4.3<Arr[x]<-4.1) or (-3.00<Arr2[y]<-2.5 and -4.3<Arr[x]<-4.1) or (-3.00<Arr2[y]<-2.5 and 4.1<Arr[x]<4.3):
            		a = True
        	elif (2.9<Arr2[y]<3.45 and 3.85<Arr[x]<4.10) or (2.9<Arr2[y]<3.45 and -4.10<Arr[x]<-3.85) or (-3.45<Arr2[y]<-2.9 and -4.10<Arr[x]<-3.85) or (-3.45<Arr2[y]<-2.9 and 3.85<Arr[x]<4.10):
            		a = True
            		...
            		a = True
        	elif (3.30<Arr2[y]<3.60 and 3.4<Arr[x]<3.65) or (3.30<Arr2[y]<3.60 and -3.65<Arr[x]<-3.4) or (-3.60<Arr2[y]<-3.30 and -3.65<Arr[x]<-3.4) or (-3.60<Arr2[y]<-3.30 and 3.4<Arr[x]<3.65):
            		a = True		
            		...
            		a = True	
        	elif (3.6<Arr2[y]<4.0 and 3.15<Arr[x]<3.45) or (3.6<Arr2[y]<4.0 and -3.45<Arr[x]<-3.15) or (-4.0<Arr2[y]<-3.6 and -3.45<Arr[x]<-3.15) or (-4.0<Arr2[y]<-3.6 and 3.15<Arr[x]<3.45):
            		a = True	
